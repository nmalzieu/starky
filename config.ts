...
let DB_PASSWORD = process.env.DB_PASSWORD || "mysecretpassword";
let DB_DATABASE = process.env.DB_DATABASE || "postgres";
...
const config = {
  NEXT_PUBLIC_DISCORD_CLIENT_ID:
    process.env.NEXT_PUBLIC_DISCORD_CLIENT_ID || "1359767529102377000",
  DISCORD_BOT_TOKEN:
    process.env.DISCORD_BOT_TOKEN ||
    "MTM1OTc2NzUyOTEwMjM3NzAwMA.GWaXgu.SGoN2YTQlG-JnqemJeYZCqtgR46ujIZNnjpEm0",
