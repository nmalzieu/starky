...
export class addingDiscordServerConfig1669304570811 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "discord_server_config" ("id" SERIAL NOT NULL, "discordServerId" character varying NOT NULL, "starknetNetwork" character varying NOT NULL, "discordRoleId" character varying NOT NULL, "starkyModuleType" character varying NOT NULL, "starkyModuleConfig" jsonb NOT NULL DEFAULT '{}', CONSTRAINT "PK_42cff3583fdfec30b0c08f24771" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_ab33e9fae2e02c53317a3fa570" ON "discord_member" ("discordMemberId", "discordServerId", "starknetNetwork") WHERE "deletedAt" IS NULL`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_bd764a6b4638ea91314d644a5e" ON "discord_member" ("discordMemberId", "discordServerId", "starknetNetwork", "deletedAt") WHERE "deletedAt" IS NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_bd764a6b4638ea91314d644a5e"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_ab33e9fae2e02c53317a3fa570"`);
